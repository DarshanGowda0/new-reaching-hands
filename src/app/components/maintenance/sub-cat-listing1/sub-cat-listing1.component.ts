...
@Component({
  selector: 'app-sub-cat-listing1',
  templateUrl: './sub-cat-listing1.component.html',
  styleUrls: ['./sub-cat-listing1.component.css']
})
export class SubCatListing1Component implements OnInit {
  ...
  onTap(id) {
    this.router.navigate(['item-details1', id]);
  }
